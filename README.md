...
Open `http://localhost:4173/home/`. The QPU lab is at `/projects/qpu/` and `/workbench/`.
...
| `qpu/` | Vendored QPU workbench source |
| `workbench/` | Generated Vite build of `qpu/` — not in git |
